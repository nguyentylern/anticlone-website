...
<div class="content">
    ...
    <main style="width: min(100%, 60ch);">
        <section>
            ...
            <p>We also constructed some goals that we wanted to reach with our solution: the change to the reference audio should be virtually imperceptible, the output from a speech-generating model using our processed audio should be noticeably worse in quality compared to an output produced using non-processed audio. These goals are also inspired by Glaze and Nightshade's functionality.</p>

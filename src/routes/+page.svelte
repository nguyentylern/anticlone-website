...
<style>
    header {
        ...
        padding: 1rem;
        /* background-image: url('https://cdn.comsol.com/wordpress/2018/08/chladni-pattern-1.png'); */
        background-image: url('$lib/assets/hero-2.webp');
    ...
    .content {
        /* display: grid;
        grid-template-columns: minmax(12ch, 19ch) 1fr; */
        display: flex;
...
<header>
    <!-- <h1>Anticlone</h1> -->
    <svg width="524" height="97" viewBox="0 0 524 97" fill="none" xmlns="http://www.w3.org/2000/svg">
        <title>ANTICLONE</title>
